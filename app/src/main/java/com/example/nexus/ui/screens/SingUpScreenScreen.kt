...
@Composable
fun SingUpScreenScreen(navController: NavController) {
    ...
    ColumnBackgroundColor {
        ...
        Text(
            text = stringResource(id = R.string.account_create),
            fontSize = 22.sp,
        ...
        AnimatedBorderCard(
            ...
            Column(
                ...
                TextFieldCustom(
                    ...
                    hint = stringResource(id = R.string.hint_username_register),
                ...
                ButtomCustom(
                    ...
                    Text(text = stringResource(id = R.string.btn_new_account))
                }
            }
        }
...
private fun SingUpScreenScreenPreview() {
    ...
    SingUpScreenScreen(navController)
}
